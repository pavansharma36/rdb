...
PLUGINS=(postgres mongodb rabbitmq ssh sftp snowflake mysql mssql s3 curlui)
CRATES=(rdb-plugin-postgres rdb-plugin-mongodb rdb-plugin-rabbitmq rdb-plugin-ssh rdb-plugin-sftp rdb-plugin-snowflake rdb-plugin-mysql rdb-plugin-mssql rdb-plugin-s3 rdb-plugin-curlui)
